...
\author{Enrique Ulises Báez Gómez Tagle
    % \\Luis Alejandro Guillén Alvarez\\Grupo2
}
\date{\today}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{../latex/utils/tables/corr_W_vs_X.tex}
...
\input{../latex/utils/tables/ols_simple_summary.tex}
...
\input{../latex/utils/tables/formas_funcionales_summary.tex}
...
\input{../latex/utils/tables/significancia_global_ols.tex}

\input{../latex/utils/tables/significancia_ols.tex}
